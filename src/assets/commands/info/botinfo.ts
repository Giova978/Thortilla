...
module.exports = class extends Command {
    ...
    public async run(message: Message, args: string[], channel: TextChannelCS) {
        const embed = new MessageEmbed()
            ...
            Currently in ${this.handler.client.guilds.cache.size} guilds with ${this.handler.client.guilds.cache.reduce((acc, guild) => acc + guild.members.cache.size, 0)} members
